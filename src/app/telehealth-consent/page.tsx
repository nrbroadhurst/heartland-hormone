...
export const metadata: Metadata = pageMeta({
  title: "Virtual Care Consent",
  description: `Virtual care consent information for ${SITE.name}.`,
  ...
  return (
    <>
      <PageHero
        ...
        title="Virtual Care Consent"
        description="Information about receiving follow-up care through secure video visits. Formal consent may also be collected in your patient portal."
      />
      <article className="mx-auto max-w-3xl px-4 py-14 md:px-6 space-y-8 text-charcoal/90 leading-relaxed">
        <p className="text-sm text-charcoal/60">Last updated: August 24, 2026</p>

        <section className="space-y-3">
          <h2 className="font-display text-2xl text-teal tracking-wide">Overview</h2>
          <p>{SITE.virtualCareStatement}</p>
          <p>
            Current service area: {SITE.virtualCareStates.join(", ")}. You should
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              Virtual visits can be convenient for follow-up, but they have limits
            ...
            <li>
              You may decline a virtual visit and request in-person care when
              that option is available.
            </li>
            <li>
              Virtual care is not for emergencies. Call 911 or go to the nearest
